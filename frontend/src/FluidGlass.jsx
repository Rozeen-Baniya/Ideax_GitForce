...
export default function FluidGlass({ mode = 'lens', lensProps = {}, barProps = {}, cubeProps = {} }) {
    ...
    return (
        <Canvas camera={{ position: [0, 0, 20], fov: 15 }} gl={{ alpha: true }}>
            {/* 
          Adding 'style' to ScrollControls to hide scrollbar. 
          Note: Drei's ScrollControls spreads props to the inner container or accepts a 'style' prop. 
          We use a standard CSS approach for the scroll container.
      */}
            <ScrollControls
                damping={0.2}
                pages={3}
...
// Helper to inject Global CSS for hiding default scrollbars within this component's context
